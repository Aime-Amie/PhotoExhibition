package ru.uj.photoexhibition.SlideShowDialog;
...
/**
 * Created by Blokhin Evgeny on 19.11.2018.
 */
public class SlideShowDialogFragment extends DialogFragment {
    ...
    public static SlideShowDialogFragment newInstance(int position) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        images = PhotoLab.get(getActivity()).getPhotos();
    ...
    private void displayMetaInfo(int position) {
        ...
        lblTitle.setText(photo.getPhotoFilename());
        lblDate.setText(photo.getmTimesStamp());
    }
